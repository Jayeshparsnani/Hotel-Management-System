...
<div class="navbar">
  ...
  <div class="name">
      <a href="user.php" style="text-decoration: none;"><p>DJJ HOTELS</p></a>
  </div>
  <div class="login">
      <a href="login.php" style="text-decoration: none;"><p>BOOK</p></a>
  </div>
  <div class="book">
    <div class="dropdown1">
    <?php
        ...
        session_start();
        $user=$_SESSION['id'];
        $userentry=$conn->query("SELECT * from registered_customer where cust_id=$user");
        $row2=mysqli_fetch_assoc($userentry);
        $firstname=$row2['First_name'];
      echo'<button onclick="myFunction()" class="dropbtn1" style="text-decoration: none;"><p>'.$firstname.'</p></button>';
      ?>
...
<div class="d1">
<div>
<a class="d4" href="search.html"><p class="d2" >My Reservations</p></a>
<p class="d3">Contact:9834692325</p>
</div>
<div class="d9">
<a class="d7" href="search.html"><p class="d5" >Conference Room</p></a>
